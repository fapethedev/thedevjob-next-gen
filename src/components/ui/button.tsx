...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-slate-300",
    {
        variants: {
            variant: {
                default:
                    "bg-primary text-secondary shadow hover:bg-primary-alt dark:bg-secondary dark:text-primary dark:hover:bg-secondary-alt",
                destructive:
                    "bg-red-500 text-slate-50 shadow-sm hover:bg-red-500/90 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/90",
                outline:
                    "border border-primary bg-slate-50 shadow-sm text-primary hover:bg-primary hover:text-slate-50 dark:border-secondary dark:bg-slate-950/80 dark:text-secondary dark:hover:border-secondary-alt dark:hover:text-secondary-alt",
                secondary:
